...
- **Clustering**: It aims to group data points based pn similarity without predifined labels. Can't be applied in the frames of our project because again, **Cargo Capacity (kg)** is a continuous measurement.
